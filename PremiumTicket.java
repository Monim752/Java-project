...
public class PremiumTicket extends Ticket{
	...
	public PremiumTicket(int ticket_ID, String ticketName, int biman_ID, int user_id, int price, int regularDiscount, int businessDiscount, int premiumDiscount, int seatNo) {
	...
	void adjustRegularDiscount() {
		...
		dec = premiumDiscount*super.price/100;
		super.price -= dec;
