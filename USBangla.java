...
public class USBangla extends Aeroplane implements AeroplaneInterface {
	
	public USBangla() {
		
	}
	
	public USBangla(int id,String bimanName,String from,String to,String date,String time,String duration,int regularPrice,int businessPrice,int premiumPrice,int maxSeat) {
		super.id = id;
	...
	public void debug() {
		System.out.println("Reached US Bangla");
	}
